...
namespace SoftEther.VPNServerRpc
{
    public class VpnServerRpc
    {
        ...
        public VpnServerRpc(string vpnserver_host, int vpnserver_port, string admin_password, string hub_name = null)
        {
            ...
            //JsonRpcClient c = new JsonRpcClient("http://pc33:88/jsonrpc/", null);

            JsonRpcClient c = new JsonRpcClient("https://127.0.0.1:443/jsonrpc/", null);
            //JsonRpcClient c = new JsonRpcClient("https://pc33.sec.softether.co.jp:443/jsonrpc/", null);
