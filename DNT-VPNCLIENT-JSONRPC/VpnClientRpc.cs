...
namespace SoftEther.VPNClientRpc
{
    public class VpnClientRpc
    {
        ...
        /// <summary>
        /// Get current VPN Client version information (Async mode)
        /// </summary>
        ...
        /// <summary>
        /// Get the CM_SETTING (VPN Client basic settings) (Sync mode)
        /// </summary>
        public VpnCmSetting GetCmSetting(VpnCmSetting input_param) => GetCmSettingAsync(input_param).Result;

        /// <summary>
        /// Set the CM_SETTING (VPN Client basic settings) (Async mode)
        /// </summary>
        ...
        /// <summary>
        /// Set the CM_SETTING (VPN Client basic settings) (Sync mode)
        /// </summary>
        public VpnCmSetting SetCmSetting(VpnCmSetting input_param) => SetCmSettingAsync(input_param).Result;

        /// <summary>
        /// Set the VPN Client administration password (Async mode)
        /// </summary>
        ...
        /// <summary>
        /// Set the VPN Client administration password (Sync mode)
        /// </summary>
        public VpnRpcClientPassword SetPassword(VpnRpcClientPassword input_param) => SetPasswordAsync(input_param).Result;

        /// <summary>
        /// Get the VPN Client administration password setting (Async mode)
        /// </summary>
        ...
        /// <summary>
        /// Get the VPN Client administration password setting (Sync mode)
        /// </summary>
        ...
        /// <summary>
        /// Enumerate the trusted CA list on the VPN Client (Async mode)
        /// </summary>
        ...
        /// <summary>
        /// Specifying a hardware secure device to be used (Sync mode)
        /// </summary>
        public VpnRpcUseSecure UseSecure(VpnRpcUseSecure input_param) => UseSecureAsync(input_param).Result;

        /// <summary>
        /// Get the hardware secure device to be used (Async mode)
        /// </summary>
        ...
        /// <summary>
        /// Get the hardware secure device to be used (Sync mode)
        /// </summary>
        ...
        /// <summary>
        /// Create a Virtual Network Adapter (Async mode)
        /// </summary>
        ...
        /// <summary>
        /// Get the information about the Virtual Network Adapter (Sync mode)
        /// </summary>
        public VpnRpcClientGetVlan GetVLan(VpnRpcClientGetVlan input_param) => GetVLanAsync(input_param).Result;

        /// <summary>
        /// Set the information about the Virtual Network Adapter (Async mode)
        /// </summary>
        ...
        /// <summary>
        /// Set the information about the Virtual Network Adapter (Sync mode)
        /// </summary>
        public VpnRpcClientSetVlan SetVLan(VpnRpcClientSetVlan input_param) => SetVLanAsync(input_param).Result;

        /// <summary>
        /// Enumerate Virtual Network Adapters (Async mode)
        /// </summary>
        ...
        /// <summary>
        /// Create an Connection Setting (Sync mode)
        /// </summary>
        ...
        /// <summary>
        /// Enumeration of Connection Settings (Async mode)
        /// </summary>
        ...
        /// <summary>
        /// Delete the Connection Setting (Sync mode)
        /// </summary>
        ...
        /// <summary>
        /// Set the Connection Setting as a start-up account (Async mode)
        /// </summary>
        ...
        /// <summary>
        /// Set the Connection Setting as a start-up account (Sync mode)
        /// </summary>
        ...
        /// <summary>
        /// Unset the startup attribute of the Connection Setting (Async mode)
        /// </summary>
        ...
        /// <summary>
        /// Unset the startup attribute of the Connection Setting (Sync mode)
        /// </summary>
        ...
        /// <summary>
        /// Get the issuer of the specified X.509 certificate (Async mode)
        /// </summary>
        ...
        /// <summary>
        /// Get the issuer of the specified X.509 certificate (Sync mode)
        /// </summary>
        public VpnRpcGetIssuer GetIssuer(VpnRpcGetIssuer input_param) => GetIssuerAsync(input_param).Result;

        /// <summary>
        /// Configure the Connection Setting (Async mode)
        /// </summary>
        ...
        /// <summary>
        /// Get the VPN Client configuration (Sync mode)
        /// </summary>
        public VpnClientConfig GetClientConfig(VpnClientConfig input_param) => GetClientConfigAsync(input_param).Result;

        /// <summary>
        /// Start the VPN connect operation of the Connection Setting (Async mode)
        /// </summary>
        ...
        /// <summary>
        /// Start the VPN connect operation of the Connection Setting (Sync mode)
        /// </summary>
        public VpnRpcClientConnect Connect(VpnRpcClientConnect input_param) => ConnectAsync(input_param).Result;

        /// <summary>
        /// Disconnect the VPN connect operation of the Connection Setting (Async mode)
        /// </summary>
        ...
        /// <summary>
        /// Disconnect the VPN connect operation of the Connection Setting (Sync mode)
        /// </summary>
        public VpnRpcClientConnect Disconnect(VpnRpcClientConnect input_param) => DisconnectAsync(input_param).Result;

        /// <summary>
        /// Get the current connection status of the Connection Setting (Async mode)
        /// </summary>
        ...
        /// <summary>
        /// Get the current connection status of the Connection Setting (Sync mode)
        /// </summary>
